# Multiple Business Emails, One Microsoft 365 Tenant: A Case Study | OS Technology Blog

> One entrepreneur, ten email addresses, ten different domains, spread across Google Workspace, private mail servers and cheap web hosts. Here's how we brought it all under one Microsoft 365 tenant, and how to spot if your business needs the same.

Source: https://ostechnology.uk/blog/multiple-business-emails-one-microsoft-365-tenant
...
*Update: while we were working on this project, we also took a look at the client’s other business accounts. [Read the follow-up on tidying up their password management](https://ostechnology.uk/blog/multiple-business-passwords-one-password-manager).*
...
[Send us a message](https://ostechnology.uk/blog/multiple-business-emails-one-microsoft-365-tenant#contact)
...
[Microsoft Modern WorkplaceMicrosoft 365 licence reviews, migrations, multi-domain tenant setup and ongoing management, done right first time.View Service →](https://ostechnology.uk/services/business/modern-workplace)
...
[Entrepreneurs & Multi-Business OwnersUmbrella IT support built for entrepreneurs running several businesses at once.View Industry →](https://ostechnology.uk/industries/it-support-for-entrepreneurs)
