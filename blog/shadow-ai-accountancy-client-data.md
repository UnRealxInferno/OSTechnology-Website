# Shadow AI and Client Data: The Hidden Risk in Your Accountancy Practice | OS Technology Blog

> Staff at your accountancy firm are probably already using AI tools on client data, tax returns, payroll, bank statements, without formal sign-off. Here's why that matters under UK GDPR and what a sensible policy looks like.

Source: https://ostechnology.uk/blog/shadow-ai-accountancy-client-data
...
Cybersecurity · 6 August 2026 · OS Technology Team · 4 min read
...
- **Separate business and personal accounts.** Business-tier AI tools, including the [Microsoft 365 Copilot](https://ostechnology.uk/services/business/modern-workplace) options many firms already have access to, come with proper data handling terms. Free personal accounts generally don’t.
- **Tighten the basics first.** Strong password management, two-factor authentication on email and client portals, and up-to-date [endpoint protection](https://ostechnology.uk/services/business/cybersecurity) across every device close off far more risk than any AI-specific policy will on its own.
...
Not sure what AI tools your team is actually using? [See our cybersecurity services](https://ostechnology.uk/services/business/cybersecurity) or [talk to us](https://ostechnology.uk/blog/shadow-ai-accountancy-client-data#contact).

[Get a Free Security Audit](https://ostechnology.uk/free-cybersecurity-audit)
...
[Get Your Free Audit](https://ostechnology.uk/free-cybersecurity-audit) [07942 942 662](https://ostechnology.uk/blog/shadow-ai-accountancy-client-data#contact)
...
Phone Number Optional, include country code if outside UK
...
[Send us a message](https://ostechnology.uk/blog/shadow-ai-accountancy-client-data#contact)
...
[Business CybersecuritySecurity audits, endpoint protection, staff training and incident response.View Service →](https://ostechnology.uk/services/business/cybersecurity)

###

[Microsoft Modern WorkplaceBusiness-grade Microsoft 365 and Copilot, set up with proper data protections from day one.View Service →](https://ostechnology.uk/services/business/modern-workplace)

###

[IT Support for AccountantsManaged IT support built around the security and compliance needs of accountancy practices.View Industry →](https://ostechnology.uk/industries/it-support-for-accountants)
